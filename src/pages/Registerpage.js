            ...
            <Grid container sx={{display: "flex",flex: "wrap",justifyContent: "space-around" }}>
              <Grid item sm={12} md={5} sx={{ width: 1, display: "flex", flexDirection: "column" }}>
                ...
                <TextField
                  ...
                  name="ad"
                  variant="outlined"
                  value={values.address}{...register("ad", { required: true, maxLength: 10 })}
              ...
              <Grid item sm={12} md={5} sx={{ width: 1, display: "flex", flexDirection: "column" }}>
                <TextField
                  ...
                  label="Email: "
                  variant="outlined"
                  value={values.email}{...register("email", {required: true,pattern: /\S+@\S+\.\S+/,})}
                ...
                <TextField
                  ...
                  label="Password: "
                  variant="outlined"
                  value={values.password}{...register("pw", { required: true, minLength: 8 })}
                ...
                <TextField
                  ...
                  variant="outlined"
                  value={values.confirmPassword}{...register("cpw", { required: true, minLength: 8 })}
